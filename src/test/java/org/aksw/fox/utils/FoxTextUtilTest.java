...
public class FoxTextUtilTest {
  ...
  String expected =
      "Das Neue Augusteum am Augustusplatz ist seit Sommer 2012 das Hauptgebäude der Universität Leipzig. Es beherbergt u.a. das Audimax mit 800 Sitzplätzen."
  ...
  public void getIndicesTest() {
    ...
    Assert.assertTrue(
        11 == FoxTextUtil.getIndices("    Augusteum    ", "  " + expected).iterator().next());
  }
}
