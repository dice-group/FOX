    ...
    public boolean checkrules(RelationMention relationMention) {
        ...
        if (relationMention.getType() != null && relationMention.getType() != StanfordRelations.NoRelation.toString()) {
            ...
            if (entities.size() != 2) {
                ...
                case Live_In:
                    if (EntityClassMap.P.equals(NERStanford.stanford(emOne.getType())) &&
                            EntityClassMap.L.equals(NERStanford.stanford(emTwo.getType())))
                        valid = true;
                    break;

                case Work_For:
                    if (EntityClassMap.P.equals(NERStanford.stanford(emOne.getType())) &&
                            EntityClassMap.O.equals(NERStanford.stanford(emTwo.getType())))
                        valid = true;
                    break;
                case OrgBased_In:
                    if (EntityClassMap.O.equals(NERStanford.stanford(emOne.getType())) &&
                            EntityClassMap.L.equals(NERStanford.stanford(emTwo.getType())))
                        valid = true;
                    break;
                case Located_In:
                    if (EntityClassMap.L.equals(NERStanford.stanford(emOne.getType())) &&
                            EntityClassMap.L.equals(NERStanford.stanford(emTwo.getType())))
                        valid = true;
                    break;
                default: {
            ...
            for (CoreMap sentenceAnnotation : doc.get(CoreAnnotations.SentencesAnnotation.class)) {
                ...
                for (RelationMention relationMention : relationMentions) {
                    ...
                    if (c) {
                        ...
                        Entity a = new Entity(emOne.getExtentString(), NERStanford.stanford(emOne.getType()), Entity.DEFAULT_RELEVANCE, getToolName());
                        Entity b = new Entity(emTwo.getExtentString(), NERStanford.stanford(emTwo.getType()), Entity.DEFAULT_RELEVANCE, getToolName());
