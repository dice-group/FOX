...
public class TagMeCommon extends AbstractNER {
    ...
    public TagMeCommon(String lang) {
        LANG = lang;
    }
    ...
    public String sendToSTring(String input) throws ClientProtocolException, IOException {
        ...
        LOG.info(new JSONObject(r).toString(2));
        return r;
    }
        ...
        if (answer != null) {
            ...
            if (jo.has("annotations")) {
                ...
                for (int i = 0; i < annotations.length(); i++) {
                    ...
                    if (annotations.getJSONObject(i).has("dbpedia_categories")) {
            ...
            while (it_weight.hasNext()) {
                ...
                // adds the label to the category list
