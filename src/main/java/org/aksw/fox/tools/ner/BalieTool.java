...
import org.aksw.fox.tools.ner.en.NERBalie;
...
public class BalieTool extends AbstractNER {
    ...
    public BalieTool(String lang) {
        ...
        entityClasses.put("nothing", EntityClassMap.N);
    }
