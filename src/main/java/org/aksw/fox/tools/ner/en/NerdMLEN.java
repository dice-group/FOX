...
public class NerdMLEN extends AbstractNER {
  ...
  public static final String CFG_KEY_ExtractorType =
      NerdMLEN.class.getName().concat(".extractorType");
  public static final String CFG_KEY_DocumentType =
      NerdMLEN.class.getName().concat(".documentType");

  public static void main(final String[] a) {

    final NerdMLEN nerdml = new NerdMLEN();
    LOG.info(nerdml.retrieve("@Pretty_Since naa,im going too be chilling w. mad heads."));
    /*
     * [text=Gottfried Wilhelm Leibniz, type=http://nerd.eurecom.fr/ontology#Person, tool=NERNerdML,
     * relevance=0.5]
     */
  }
  ...
  public List<org.aksw.fox.data.Entity> retrieve(final String input) {
    ...
    final List<Entity> nerdlist = nerd.annotate(
        // ExtractorType.NERDML,
        ExtractorType.valueOf(PropertiesLoader.get(CFG_KEY_ExtractorType)),
